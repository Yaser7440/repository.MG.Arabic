...
def INDEX():
    utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]3lbh.net[/COLOR]','',90,os.path.join(imgDir, '3lbh.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Shahid4u[/COLOR] : [B][COLOR yellow]Not Yet[/COLOR][/B]','http://shahid4u.com/',179,os.path.join(imgDir, 'shahid4u.png'),'')
    utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]AnakbNet[/COLOR]','http://www.anakbnet.com/video/',182,os.path.join(imgDir, 'anakbnet.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]CimaClub[/COLOR] : [B][COLOR yellow]Not Yet[/COLOR][/B]','http://cimaclub.com',450,os.path.join(imgDir, 'arbcinema.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Series4Watch[/COLOR] : [B][COLOR yellow]Not Yet[/COLOR][/B]','http://www.series4watch.tv',100,os.path.join(imgDir, 'arbcinema.png'),'')	
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]watch32[/COLOR]','http://watch32.is/',230,os.path.join(imgDir, 'arbcinema.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Movies[/COLOR]','',2,os.path.join(rootDir, 'icon.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Hentai[/COLOR]','',3,os.path.join(rootDir, 'icon.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Tubes[/COLOR]','',6,os.path.join(rootDir, 'icon.png'),'')
    # utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Webcams & Streams[/COLOR]','',7,os.path.join(rootDir, 'icon.png'),'')
    utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Favorites[/COLOR]','',901,os.path.join(rootDir, 'icon.png'),'')
    download_path = addon.getSetting('download_path')
    if download_path != '' and os.path.exists(download_path):
        utils.addDir('[COLOR red]MG.Arabic[/COLOR] [COLOR white]Download Folder[/COLOR]',download_path,4,os.path.join(rootDir, 'icon.png'),'')
