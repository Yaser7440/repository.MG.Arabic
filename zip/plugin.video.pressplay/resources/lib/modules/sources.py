...
class sources:
    ...
    def sourcesProcessTorrents(self, torrent_sources):#adjusted PressPlay code
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.pressplay.container.items'

        self.metaProperty = 'plugin.video.pressplay.container.meta'
